...
public class ErrorDialogActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (crashReport.toLowerCase().contains("failed to detect default dns server")) {
            AlertDialog alertDialog = new AlertDialog.Builder(this, ThemeHandler.getDialogTheme(this)).setTitle(getString(R.string.error) + " - " + getString(R.string.app_name))
                    ...
                    }).setMessage(Html.fromHtml("<p style=\"color=red\">"+crashReport+"</p><br><p><b>Try starting the app again when you're connected to WiFi</b></p>")).show();
        ...
        } else if(crashReport.contains("Cannot create interface")){ //Kind of dirty, but this error is unfixable
            AlertDialog alertDialog = new AlertDialog.Builder(this, ThemeHandler.getDialogTheme(this)).setTitle(getString(R.string.error) + " - " + getString(R.string.app_name))
                    .setNeutralButton(R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            new AlertDialog.Builder(this, ThemeHandler.getDialogTheme(this)).setTitle(getString(R.string.error) + " - " + getString(R.string.app_name)).setMessage(R.string.vpn_error_explain)
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if(PreferencesAccessor.isDebugEnabled(ErrorDialogActivity.this)){
                        ...
                        if(zip != null){
                            Uri zipURI = FileProvider.getUriForFile(ErrorDialogActivity.this,"edu.byu.imaal.dnscapture",zip);
