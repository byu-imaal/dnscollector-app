package edu.byu.imaal.dnscapture.tasker;
 ...
 */
public class Helper {
    static final String BUNDLE_EXTRA_DNS1 = "edu.byu.imaal.dnscapture.dns1",
            BUNDLE_EXTRA_DNS2 = "edu.byu.imaal.dnscapture.dns2",
            BUNDLE_EXTRA_DNS1V6 = "edu.byu.imaal.dnscapture.dns1v6",
            BUNDLE_EXTRA_DNS2V6 = "edu.byu.imaal.dnscapture.dns2v6",
            BUNDLE_EXTRA_STOP_DNS = "edu.byu.imaal.dnscapture.stopdns",
            BUNDLE_EXTRA_PAUSE_DNS = "edu.byu.imaal.dnscapture.pausedns",
            BUNDLE_EXTRA_RESUME_DNS = "edu.byu.imaal.dnscapture.resumedns",
            BUNDLE_EXTRA_V2= "edu.byu.imaal.dnscapture.v2";
