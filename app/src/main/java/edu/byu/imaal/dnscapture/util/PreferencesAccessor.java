...
public class PreferencesAccessor {
    ...
    private static String getDNS1(@NonNull Context context) {
        return isIPv4Enabled(context) ? Preferences.getInstance(context).getString(  "dns1", "") : "";
    }

    @NonNull
    private static String getDNS2(@NonNull Context context) {
        return isIPv4Enabled(context) ? Preferences.getInstance(context).getString(  "dns2", "") : "";
    }

    @NonNull
    private static String getDNS1V6(@NonNull Context context) {
        return isIPv6Enabled(context) ? Preferences.getInstance(context).getString(  "dns1-v6", "") : "";
    }

    @NonNull
    private static String getDNS2V6(@NonNull Context context) {
        return isIPv6Enabled(context) ? Preferences.getInstance(context).getString(  "dns2-v6", "") : "";
    }
    ...
    public enum Type{
        DNS1("dns1", "port1", ""),
        DNS2("dns2", "port2", ""),
        DNS1_V6("dns1-v6", "port1v6", ""),
        DNS2_V6("dns2-v6", "port2v6", "");
