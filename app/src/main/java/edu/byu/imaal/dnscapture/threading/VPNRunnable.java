package edu.byu.imaal.dnscapture.threading;
...
import edu.byu.imaal.dnscapture.activities.BackgroundVpnConfigureActivity;
import edu.byu.imaal.dnscapture.activities.InvalidDNSDialogActivity;
...
import edu.byu.imaal.dnscapture.util.dnsproxy.DNSProxy;
import edu.byu.imaal.dnscapture.util.dnsproxy.DummyProxy;
...
public class VPNRunnable implements Runnable {
    ...
    public void run() {
        ...
        if(service.getApplicationContext() instanceof DNSCollector) {
            Thread.setDefaultUncaughtExceptionHandler(((DNSCollector)service.getApplicationContext()).getExceptionHandler());
        }
