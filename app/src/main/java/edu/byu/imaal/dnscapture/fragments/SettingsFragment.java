...
import edu.byu.imaal.dnscapture.activities.AdvancedSettingsActivity;
import edu.byu.imaal.dnscapture.activities.AppSelectionActivity;
import edu.byu.imaal.dnscapture.activities.MainActivity;
import edu.byu.imaal.dnscapture.receivers.AdminReceiver;
import edu.byu.imaal.dnscapture.services.DNSVpnService;
import edu.byu.imaal.dnscapture.tasker.ConfigureActivity;
...
import edu.byu.imaal.dnscapture.util.VPNServiceArgument;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sendDebugPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                Uri zipURI = FileProvider.getUriForFile(requireContext(), "edu.byu.imaal.dnscapture", zip);
        ...
        findPreference("disable_crash_reporting").setOnPreferenceChangeListener(
                new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        if(newState) {
                            ((DNSCollector) requireContext().getApplicationContext()).setupSentry();
                        } else {
                            ((DNSCollector) requireContext().getApplicationContext()).tearDownSentry();
                        }
                        return true;
                    }
                });
...
//            ((MainActivity)requireContext()).reloadMenuItems();
    ...
    @Override
    public androidx.preference.PreferenceGroup getTopLevelPreferenceGroup() {
